...
of the function \term{revenue}, which implements
...
In the \term{for}-loop, we compare the current
...
client ids in \term{mx[1]}, \term{mx[3]} and
...
of all global variables (\ie\ the \term{global table}
