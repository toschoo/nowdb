...
or \term{destination} (which is usually abbreviated
...
to \term{stamp}). This field needs not to be mentioned
...
price, a \term{float}. \term{Origin} is of type
...
You may note that we have not created indices.
