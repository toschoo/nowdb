...
there is not \term{Connection} class.
...
or, on internal errors, raises the exceptions \term{DBError}.
...
The method adds the \term{value}
as \nowdb\ \sql\ type \term{t} to
...
The method inserts an \term{end-of-row} marker to the row.
