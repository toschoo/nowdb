...
\keyword{select} \identifier{sum}(\identifier{weight})
  \keyword{from} \identifier{sales}
...
\keyword{select} \identifier{max}(\identifier{weight}),
                 \identifier{min}(\identifier{weight})
\keyword{from} \identifier{sales}
...
\keyword{select} \identifier{spread}(\identifier{weight})
\keyword{from} \identifier{sales}
...
\keyword{select} \identifier{avg}(\identifier{weight})
\keyword{from} \identifier{sales}
...
\keyword{select} \identifier{median}(\identifier{weight})
\keyword{from} \identifier{sales}
...
\keyword{select} \identifier{mode}(\identifier{weight})
\keyword{from} \identifier{sales}
...
have two fields: \keyword{origin} and \keyword{destin}, \eg:
...
\keyword{select} \identifier{sum}(\identifier{weight}) $/$ 42 \\
\keyword{select} \identifier{count}(*), \identifier{sum}(\identifier{weight})
\end{minipage}
...
\keyword{select} \identifier{sum}(\identifier{weight}) \\
\keyword{select} \identifier{sum}(\identifier{log}(\identifier{weight})) \\
\keyword{select} \identifier{avg}((\identifier{weight} $+$
                                   \identifier{weight2}) $/$ 2) \\
\keyword{select} \identifier{stddev}(\identifier{weight})
