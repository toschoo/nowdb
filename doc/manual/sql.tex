...
they can only be used with in a \keyword{case}.
...
This is of significant importance in the \keyword{where} clause.
...
\paragraph{Coalesce}
\identifier{Coalesce} is a function that accepts a list of expressions
as its argument. \identifier{Coalesce} evaluates to
the first value in the list that is \keyword{not null}.
If none of the values in the list is \keyword{not null},
...
The list may contain an undetermined number of values.
For instance:
...
The values in the list may be of different types.
